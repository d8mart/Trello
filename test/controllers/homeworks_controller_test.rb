...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { author: @homework.author, description: @homework.description, duration: @homework.duration, end_date: @homework.end_date, start_date: @homework.start_date, status: @homework.status, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { author: @homework.author, description: @homework.description, duration: @homework.duration, end_date: @homework.end_date, start_date: @homework.start_date, status: @homework.status, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
